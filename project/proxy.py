...
class ModelProxy:
    ...
    def __filter_by_prob(self, probability: float):
        return self.__model_predictions.loc[
            self.__model_predictions["scores"] >= probability
        ]
...
if __name__ == "__main__":
    model = ModelProxy()
    paths = [
        "D:\Personal\Torpedo\Deepfish\Project\DATASET\\29_04_21-B22.jpg",
        "D:\Personal\Torpedo\Deepfish\Project\DATASET\\29_04_21-B21.jpg",
    ]
